...
async def start(message: types.Message):
    ...
    await message.bot.send_message(message.from_user.id, "БОТ немного не доделан но HELLO WORLD!")
    await message.bot.send_message(message.from_user.id, "Доступные команды Бота: /e доход, /s расход, /h история ")
